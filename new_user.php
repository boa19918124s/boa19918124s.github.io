        ...
        <div class="card-body">
            <form action="" id="manage_user">
                    ...
                    <div class="col-md-6 border-right">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select custom-select-sm">
                                ...
                                <option <?php echo isset($gender) && $gender == 'Male' ? 'selected' : "" ?>>Male
                                </option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="" class="control-label">聯絡電話</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="custom-select custom-select-sm">
                                <option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>一般使用者
                                </option>
                                <option value="1" <?php echo isset($type) && $type == 1 ? 'selected' : '' ?>>管理者
                                </option>
                            </select>
                        </div>
                        <?php else: ?>
                        ...
                        <div class="form-group">
                            ...
                            <small><i><?php echo isset($id) ? "維持空白，即不變更新密碼" : '' ?></i></small>
                        </div>
                        <div class="form-group">
                            <label class="label control-label">確認密碼</label>
                ...
                <div class="col-lg-12 text-right justify-content-center d-flex">
                    <button class="btn btn-primary mr-2">存檔</button>
                    <button class="btn btn-secondary" type="button"
                        onclick="location.href = 'index.php?page=user_list'">取消</button>
                </div>
            </form>
        </div>
    </div>
