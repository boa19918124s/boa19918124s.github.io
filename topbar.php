        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.5em;">
                <button class="dropdown-item" type="button" id="my_profile"><i class="fa fa-id-card"></i>
                    個人檔案</button>
                <button class="dropdown-item" type="button" id="manage_my_account"><i class="fa fa-cog"></i>
                    帳號管理</button>
                <button class="dropdown-item" onclick="location.href='ajax.php?action=logout'"><i
                        class="fa fa-power-off"></i> 登出帳號</button>
            </div>
        </li>
    </ul>
</nav>
...
$('#manage_my_account').click(function() {
    uni_modal("帳號管理", "manage_account.php", "large")
})
$('#my_profile').click(function() {
    uni_modal("個人檔案", "view_user.php?id=<?php echo $_SESSION['login_id'] ?>")
})
</script>
<!-- /.navbar -->