...
<div class="container-fluid">
    <form action="" id="manage-genre">
        ...
        <div class="form-group">
            <label for="genre" class="control-label">類型</label>
            <input type="text" class="form-control form-control-sm" name="genre" id="genre"
                value="<?php echo isset($genre) ? $genre : '' ?>">
        </div>
        <div class="form-group">
            <label for="description" class="control-label">內容描述</label>
