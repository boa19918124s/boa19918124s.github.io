    ...
    <div class="row">
        <div class="col-md-4">
                ...
                <div class="d-flex img-thumbnail bg-gradient-1 position-relative" style="width: 12rem">
                    ...
                    <span class="position-absolute" style="bottom:.5em;left:.5em">
                        <div class=" bg-green rounded-circle d-flex justify-content-center align-items-center"
                            style="width: 2rem;height: 2rem;cursor: pointer;" onclick="play_playlist()"><i
            ...
            <div>
                ...
                <center>
                    <button class="btn btn-primary mt-2" type="button" id="manage_plist">清單管理</button>
                </center>
                <?php endif;?>
            </div>
            <div>
        ...
        <div class="col-md-8">
            <h5 class="text-white">標題: <?php echo ucwords($ptitle); ?></h5>
            <h6 class="text-white border-bottom border-primary"><b class="text-white">內容描述:</b></h6>
