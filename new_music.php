                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group text-dark">
                            <label for="" class="control-label">音樂類型</label>
...
?>
                                <option value="<?php echo $row['id'] ?>"
                                    <?php echo isset($genre_id) && $genre_id == $row['id'] ? 'selected' : '' ?>>
                                    <?php echo ucwords($row['genre']) ?></option>
                                <?php endwhile;?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="" class="control-label">標題</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="" class="control-label">作曲者</label>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                            <label for="" class="control-label">內容描述:</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="" class="control-label">上傳音樂</label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="customFile" name="audio"
                                    accept="audio/*"
                                    <?php echo !isset($upath) || (isset($upath) && empty($upath)) ? "required" : '' ?>>
...
?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="" class="control-label">專輯封面</label>
                            <div class="custom-file">
                        ...
                        <div class="form-group d-flex justify-content-center">
                            <img src="assets/uploads/<?php echo isset($cover_image) ? $cover_image : '' ?>" alt=""
        ...
        <div class="card-footer border-top border-info">
            <div class="d-flex w-100 justify-content-center align-items-center">
                <button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-music">存檔</button>
                <button class="btn btn-flat bg-gradient-secondary mx-2" type="button">取消</button>
            </div>
        </div>
    </div>
</div>
