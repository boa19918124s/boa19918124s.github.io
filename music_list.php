...
<div class="col-lg-12">
    <div class="d-flex justify-content-between align-items-center w-100">
        ...
        <a class="btn btn-sm btn-primary bg-gradient-primary" href="index.php?page=new_music"><i
                class="fa fa-plus"></i>新增</a>
    </div>
    <button class="btn btn-primary" id="play_all">播放全部</button>
                ...
                <div class="dropdown position-absolute" style="right:.5em;top:.5em">
                    ...
                    <div class="dropdown-menu bg-dark">
                        <a class="dropdown-item bg-dark" data-id="<?php echo $row['id'] ?>"
                            href="index.php?page=edit_music&id=<?php echo $row['id'] ?>">編輯</a>
                        <a class="dropdown-item delete_music bg-dark" data-id="<?php echo $row['id'] ?>"
...
function check_list() {
    ...
    if (count > 0) {
        ...
        var ns = $(
            '<div class="col-md-12 text-center text-white" id="ns"><b><i>No data to be display.</i></b></b></div>')
