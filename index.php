...
?>
                ...
                <div id="audio-player"
                    ...
                    <button class="btn p-player audio-control-btn" onclick="_player($(this))" data-queue="0"
                        data-type="play" style="font-size: 25px"><i class="fa fa-play"></i></button>
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        if (resp) {
                            ...
                            var _html =
                                '<div id="pdet" class="d-flex justify-content-center align-items-center"><img src="assets/uploads/' +
                                resp.cover_image +
                                '" alt="" class="img-thumbnail bg-gradient-1" style="width: 50px;height: 50px;object-fit: cover"><div class="ml-2 mr-4"><div><b><large>' +
                                resp.title + '</large></b></div><div><b><small>' + resp.artist +
                                '</small></b></div></div></div>'
